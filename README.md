...
PS: Need to confirm swapping between the summer & winter files.

* What are the peak hours in which bikes are used during winter months?
PS:  I calculated using starttime.

PS:The below have "Today". I just calculated based entire data. 
...
PS: Need to confirm why age 49 is max?

* What is the average distance in miles that a bike is ridden?
PS: Need to confirm if the calculation is correct, missing something.
...
PS: Either start or end stations can be plotted.
